...
<div class="x-body">
    ...
    <div class="table-res">
        ...
        <tr>
            <td><input name="check[]" data-check="option" type="checkbox" value="<?php echo ($result[$i][aid]); ?>"></td>
            <td><?php echo ($result[$i][id]); ?></td>
            <td><?php echo ($result[$i][name]); ?></td>
            <td><?php echo ($result[$i][age]); ?></td>
            <td><?php if($result[$i][sex]=='0') {echo'女';}else{echo '男';} ?></td>
            <td><?php echo ($result[$i][job]); ?></td>
            <td><?php echo ($result[$i][marriage]); ?></td>
            <td><?php echo ($result[$i][ps]); ?></td>
            <td><?php echo ($result[$i][mh]); ?></td>
            <td><?php echo ($result[$i][eyesurgery]); ?></td>
            <td><?php echo ($result[$i][drugallergy]); ?></td>
            <td><?php echo ($result[$i][complication]); ?></td>
            <td><?php echo ($result[$i][diagnosis]); ?></td>
            ...
            <td><a href="#"><?php echo ($result[$i][doctor]); ?></a></td>
            <td><?php echo ($result[$i][othermessage]); ?></td>
            <td class="td-manage">
                <a title="编辑"  onclick="show(this)" href="javascript:void(0)" data-btn="edit" data-user="<?php echo ($result[$i][id]); ?>" data-pagehref="<?php echo ($edit_user_page_href); ?>" data-username="<?php echo ($result[$i][name]); ?>">
                    <i class="layui-icon">&#xe642;</i>
                </a>
                <a title="删除" onclick="del(this)" href="javascript:void(0)" data-btn="delete" data-user="<?php echo ($result[$i][id]); ?>" data-pagehref="<?php echo ($disable_user_href); ?>" data-username="<?php echo ($result[$i][name]); ?>">
                    <i class="layui-icon">&#xe640;</i>
                </a>
            </td>
        </tr>
